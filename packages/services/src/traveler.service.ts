...
const createTraveler = async (api_url: string, credentials: CreateTravelerDTO, setError: Dispatch<SetStateAction<any>> | any): Promise<Traveler> => {
  return await useFetch.post(`${api_url}${API_TRAVELER_ROUTE}`, credentials, setError)
};

const updateTraveler = async (api_url: string, travelerId: string, credentials: UpdateTravelerDTO, setError: Dispatch<SetStateAction<any>> | any): Promise<Traveler> => {
...
const deleteTraveler = async (api_url: string, travelerId: string, setError: Dispatch<SetStateAction<any>> | any) => {
