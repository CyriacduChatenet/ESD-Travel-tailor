...
export const NavModule: FC<IProps> = ({ accessToken, role }) => {
    return (
        <>
            {accessToken && role && role === ROLES.ADVERTISER && <li className="block mt-4 lg:inline-block lg:mt-0 text-blue-200 hover:text-white mr-4">
                <Link href={ROUTES.ADVERTISER.DASHBOARD}>Dashboard</Link>
            </li>}
            {accessToken && role && role === ROLES.TRAVELER && <li className="block mt-4 lg:inline-block lg:mt-0 text-blue-200 hover:text-white mr-4">
            ...
            {accessToken && role && <li className="block mt-4 lg:inline-block lg:mt-0 text-blue-200 hover:text-white mr-4">
