            ...
            <tbody>
                {data.data.map((activity: Activity) =>
                    <tr key={activity.id}>
                        ...
                        <td className="py-2 px-4 border-b">{activity.tags.map((tag: ActivityTag) => <span key={tag.id} className="bg-blue-100 rounded-lg text-indigo-600 py-1 px-2">{tag.name}</span>)}</td>
