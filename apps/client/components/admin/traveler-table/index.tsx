            ...
            <tbody>
                {data.data.map((traveler: Traveler) =>
                    <tr key={traveler.id}>
                        ...
                        <td className="py-2 px-4 border-b">{traveler.tastes.map((taste: Taste) => <span key={taste.id} className="bg-indigo-100 rounded-lg text-indigo-600 py-1 px-2">{taste.id}</span>)}</td>
                        <td className="py-2 px-4 border-b">{traveler.travels.map((travel: Travel) => <span key={travel.id} className="bg-indigo-100 rounded-lg text-indigo-600 py-1 px-2">{travel.id}</span>)}</td>
                        <td className="py-2 px-4 border-b">{traveler.comments.map((comment: Comment) => <span key={comment.id} className="bg-indigo-100 rounded-lg text-indigo-600 py-1 px-2">{comment.id}</span>)}</td>
