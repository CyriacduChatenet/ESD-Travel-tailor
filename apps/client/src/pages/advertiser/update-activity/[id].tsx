...
const UpdateActivity: NextPage = () => {
  ...
  return (
    <Layout>
      ...
      <WebUpdateActivityForm api_url={`${process.env.NEXT_PUBLIC_API_URL}`} mapboxAccessToken={`${process.env.NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN}`} tags={tags} setTags={setTags} schedules={schedules} setSchedules={setSchedules} closingDays={closingDays} setClosingDays={setClosingDays} />
      <br />
      <br />
      <h3>Tags</h3>
      {tags.map((tag, index) => (
